...
function getvisitor(){
    var xhr = new XMLHttpRequest();
    var url = 'https://api.countapi.xyz/hit/akame-r.herokuapp.com/visits';
    xhr.onloadend = function(){
    data = JSON.parse(this.responseText);
...
// User Agent
txt = "";
txt += "<p><b>Versão do navegador</b>: <br>" + navigator.appVersion + "</p>";
txt += "<p><b>Língua</b>: " + navigator.language + "</p>";
txt += "<p><b>Navegador</b>: " + navigator.appCodeName + "</p>";
...
Sayings = "";
			...
			Sayings += "<span class='text-warning'>Bom Dia 🌞</span>"
			} else if (hours >= 13 && hours <= 16){
			Sayings += "<span class='text-success'>Boa noite 🌜</span>"
			}
...
var x = setInterval(function() {
  ...
  document.getElementById("IdulAdha").innerHTML = days + " Dias " + hours + " Horas "
  + minutes + " Minutos " + seconds + " Segundos ";
  if (distance < 0) {
    clearInterval(x);
    document.getElementById("IdulAdha").innerHTML = "Obg por usar Meu rest api :) ";
  }
}, 1000);
